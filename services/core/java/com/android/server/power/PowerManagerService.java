...
public final class PowerManagerService extends SystemService
    ...
    private final Intent wakeBlockServiceIntent =
            new Intent("com.giovannibozzano.wakeblock.Service");
    private final android.content.ServiceConnection wakeBlockConnection =
    ...
    public PowerManagerService(Context context) {
        ...
        // @ WAKEBLOCK
        android.os.HandlerThread wakeBlockHandlerThread =
                new android.os.HandlerThread("wakeblock_client");
    ...
    private void acquireWakeLockInternal(IBinder lock, int flags, String tag, String packageName,
        ...
        if (wakeBlockBindTime) {
            ...
            Thread thread = new Thread()
            {
                ...
                public void run()
                {
                    mContext.bindService(wakeBlockServiceIntent, wakeBlockConnection,
