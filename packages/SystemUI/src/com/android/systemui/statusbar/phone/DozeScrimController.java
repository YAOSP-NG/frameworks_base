...
public class DozeScrimController {
    ...
    public void onScreenTurnedOn() {
        if (isPulsing()) {
            ...
            startScrimAnimation(true /* inFront */, 0f,
                    pickupOrDoubleTap
                            ? mDozeParameters.mDozeFadeInDelayPickup
                            : mDozeParameters.mDozeFadeInDelayDoubleTap,
                    pickupOrDoubleTap
                            ? Interpolators.LINEAR_OUT_SLOW_IN
    ...
    private final Runnable mPulseInFinished = new Runnable() {
        ...
        public void run() {
            ...
            if (!mDozing) return;
            mHandler.postDelayed(mPulseOut, mDozeParameters.mDozeTimeoutDelay);
        }
    };
    ...
    private final Runnable mPulseOut = new Runnable() {
        ...
        public void run() {
            ...
            if (!mDozing) return;
            startScrimAnimation(true /* inFront */, 1f, mDozeParameters.mDozeFadeOutDelay,
